...
public class GlobalExceptionHandler {
    ...
    /**
     * Maneja excepciones de inventario insuficiente.
     * 
     * @param ex Excepción de inventario insuficiente
     * @return ResponseEntity con el error
     */
    @ExceptionHandler(InventarioInsuficienteException.class)
    public ResponseEntity<ErrorResponse> handleInventarioInsuficienteException(InventarioInsuficienteException ex) {
        logger.warn("Inventario insuficiente: {}", ex.getMessage());
